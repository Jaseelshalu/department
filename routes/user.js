...
router.get('/toss', verifyLogin, async (req, res) => {
  ...
  if (did) res.redirect('/')
    ...
    if (didForm) {
      ...
      let unlock = {}
      for (i = 1; i <= 30; i++) {
        if (data['sum' + i] == "1") unlock.s1 = 'true'
        else if (data['sum' + i] == "2") unlock.s2 = 'true'
        else if (data['sum' + i] == "3") unlock.s3 = 'true'
        else if (data['sum' + i] == "4") unlock.s4 = 'true'
        else if (data['sum' + i] == "5") unlock.s5 = 'true'
        else if (data['sum' + i] == "6") unlock.s6 = 'true'
        else if (data['sum' + i] == "7") unlock.s7 = 'true'
        else if (data['sum' + i] == "8") unlock.s8 = 'true'
        else if (data['sum' + i] == "9") unlock.s9 = 'true'
        else if (data['sum' + i] == "10") unlock.s10 = 'true'
        else if (data['sum' + i] == "11") unlock.s11 = 'true'
        else if (data['sum' + i] == "12") unlock.s12 = 'true'
        else if (data['sum' + i] == "13") unlock.s13 = 'true'
        else if (data['sum' + i] == "14") unlock.s14 = 'true'
        else if (data['sum' + i] == "15") unlock.s15 = 'true'
        else if (data['sum' + i] == "16") unlock.s16 = 'true'
        else if (data['sum' + i] == "17") unlock.s17 = 'true'
        else if (data['sum' + i] == "18") unlock.s18 = 'true'
        else if (data['sum' + i] == "19") unlock.s19 = 'true'
        else if (data['sum' + i] == "20") unlock.s20 = 'true'
        else if (data['sum' + i] == "21") unlock.s21 = 'true'
        else if (data['sum' + i] == "22") unlock.s22 = 'true'
        else if (data['sum' + i] == "23") unlock.s23 = 'true'
        else if (data['sum' + i] == "24") unlock.s24 = 'true'
        else if (data['sum' + i] == "25") unlock.s25 = 'true'
        else if (data['sum' + i] == "26") unlock.s26 = 'true'
        else if (data['sum' + i] == "27") unlock.s27 = 'true'
        else if (data['sum' + i] == "28") unlock.s28 = 'true'
        else if (data['sum' + i] == "29") unlock.s29 = 'true'
        else if (data['sum' + i] == "30") unlock.s30 = 'true'
      }
